...
#pragma warning restore CA1822 // Mark members as static
        {
            ...
            services.Sitecore().Pipelines(config => config.ConfigurePipeline<IBizFxNavigationPipeline>(c => c
            .Add<GetVatTaxNavigationViewBlock>())
            );
            services.Sitecore().Pipelines(config => config
               ...
               .ConfigurePipeline<ICalculateCartLinesPipeline>(d =>
                ...
                .ConfigurePipeline<IGetEntityViewPipeline>(d =>
                {
                    ...
                    .Add<GetVatTaxDashboardViewBlock>().Before<IFormatEntityViewPipeline>();
                })
                ...
                c =>
                {
                    c.Add<DoActionAddVatTaxBlock>().After<ValidateEntityVersionBlock>()
                        .Add<DoActionEditVatTaxBlock>().After<ValidateEntityVersionBlock>()
